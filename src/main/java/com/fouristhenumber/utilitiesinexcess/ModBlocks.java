...
public enum ModBlocks {
    ...
    COLORED_REDSTONE_BLOCK(BlockConfig.enableColoredBlocks, new BlockColored(Blocks.redstone_block, 2f), BlockColored.ItemBlockColored.class, "colored_redstone_blocks"),
...
//    COLORED_SAND(BlockConfig.enableColoredBlocks, new BlockColored(Blocks.sand, 1f), BlockColored.ItemBlockColored.class, "colored_sand"),
