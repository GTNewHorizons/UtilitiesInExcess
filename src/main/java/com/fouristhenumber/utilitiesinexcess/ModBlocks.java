...
public enum ModBlocks {
    ...
    DRUM(BlockConfig.enableDrum, new BlockDrum(16000, "drum"), BlockDrum.ItemBlockDrum.class, "drum"),
    BEDROCKIUM_DRUM(BlockConfig.enableDrum, new BlockDrum(64000, "bedrockium_drum"), BlockDrum.ItemBlockDrum.class, "bedrockium_drum"),
