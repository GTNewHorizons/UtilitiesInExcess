...
public enum ModBlocks {
    ...
    FURNACE_GENERATOR_PLUS(GeneratorConfig.enableFurnaceGenerator, new BlockFurnaceGeneratorPlus("furnace_generator_plus"), "furnace_generator_plus"),
    FURNACE_GENERATOR_PLUSPLUS(GeneratorConfig.enableFurnaceGenerator, new BlockFurnaceGeneratorPlusPlus("furnace_generator_plusplus"), "furnace_generator_plusplus"),
    ...
    ENDER_GENERATOR_PLUS(GeneratorConfig.enableEnderGenerator, new BlockEnderGeneratorPlus("ender_generator_plus"), "ender_generator_plus"),
    ENDER_GENERATOR_PLUSPLUS(GeneratorConfig.enableEnderGenerator, new BlockEnderGeneratorPlusPlus("ender_generator_plusplus"), "ender_generator_plusplus"),
    ...
    FOOD_GENERATOR_PlUS(GeneratorConfig.enableFoodGenerator, new BlockFoodGeneratorPlus("food_generator_plus"), "food_generator_plus"),
    FOOD_GENERATOR_PLUSPLUS(GeneratorConfig.enableFoodGenerator, new BlockFoodGeneratorPlusPlus("food_generator_plusplus"), "food_generator_plusplus"),
    ...
    PINK_GENERATOR_PLUSPLUS(GeneratorConfig.enablePinkGenerator, new BlockPinkGeneratorPlusPlus("pink_generator_plusplus"), "pink_generator_plusplus"),
