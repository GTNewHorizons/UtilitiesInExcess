...
import com.fouristhenumber.utilitiesinexcess.common.items.ItemInversionSigil;
...
public enum ModItems {
    ...
    INVERSION_SIGIL_INACTIVE(ItemConfig.enableInversionSigil, new ItemInversionSigil(), "inversion_sigil_inactive"),
