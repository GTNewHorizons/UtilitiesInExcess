...
public class BlockSortingPipe extends BlockTransferBase
{
    ...
    {
        TileEntitySortingPipe te = (TileEntitySortingPipe) world.getTileEntity(x, y, z);
        if (te == null) return;
    ...
    {
        TileEntitySortingPipe te = (TileEntitySortingPipe) worldIn.getTileEntity(x, y, z);
        if (te == null) return;
