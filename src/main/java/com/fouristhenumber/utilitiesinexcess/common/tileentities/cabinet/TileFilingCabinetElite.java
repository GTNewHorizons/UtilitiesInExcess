...
public class TileFilingCabinetElite extends TileFilingCabinetBaseItem {

    public TileFilingCabinetElite() {
        super(
            FilingCabinetsConfig.cabinetElite,
    ...
    public BlockFilingCabinet.Type getCabinetType() {
        return BlockFilingCabinet.Type.ELITE;
    }
