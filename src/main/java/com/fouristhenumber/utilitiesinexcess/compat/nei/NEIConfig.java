...
public class NEIConfig implements IConfigureNEI {
    ...
    public static void registerAliases() {
        // spotless:off
        ArrayList<ItemStack> itemStacks = new ArrayList<>(List.of(
            ...
            new ItemStack(ModBlocks.LOW_TEMPERATURE_FURNACE_GENERATOR_PLUS.get()),
            new ItemStack(ModBlocks.LOW_TEMPERATURE_FURNACE_GENERATOR_PLUSPLUS.get()),
        ...
        for (int i = 0; i < 16; i++) {
            itemStacks.add(new ItemStack(ModBlocks.LAPIS_AETHERIUS.getItem(), 1, i));
        }

        // Glass #5 is obsidian glass and is named the same
        for (int i = 0; i < 5; i++) {
            itemStacks.add(new ItemStack(ModBlocks.DECORATIVE_GLASS.getItem(), 1, i));
        }
        for (int i = 6; i < 10; i++) {
            itemStacks.add(new ItemStack(ModBlocks.DECORATIVE_GLASS.getItem(), 1, i));
        }
