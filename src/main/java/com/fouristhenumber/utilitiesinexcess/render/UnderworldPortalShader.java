...
@EventBusSubscriber
public class UnderworldPortalShader extends ShaderProgram {

    public static final UnderworldPortalShader INSTANCE = new UnderworldPortalShader();
    ...
    static {
        for (int i = 0; i < COSMIC_COUNT; i++) {
            COSMIC_TEXTURES[i] = UtilitiesInExcess.MODID + ":cosmic/cosmic" + i;
        }
    }
